...
public class IdwallFormatter extends StringFormatter {
	   ...
	   private static int CONSTANTE_0 = 0;
		...
		/**Fun��o para adicionar espa�os a mais ate chegar o tamanho necessario.
		 * 
		...
		*/
		...
		/**Fun��o que retorna o tamanho a ser lido da string, sendo o cursor do final lido + o tamanho linha, ou o final do cursor mais oque � preciso ler.
		 * 
		 * @param texto texto a ser lido
		...
		/**Fun��o recursiva retornando o ultimo espa�o antes de quebrar a palavra.
		 * 
		...
		/**Fun��o para retirar espa�os que estar�o no come�o e/ou no fim da linha.
		 * 
		 * @param texto Texto a ser lido
		 * @return texto sem os espa�os brancos
		 */
